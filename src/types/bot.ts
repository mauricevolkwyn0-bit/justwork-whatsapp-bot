export enum BotStep {
  ...
  // -- Settings ----------------------------------------
  SETTINGS_UPDATE_SECTION = "SETTINGS_UPDATE_SECTION",
  SETTINGS_EDIT_PERSONAL = "SETTINGS_EDIT_PERSONAL",
  SETTINGS_EDIT_PERSONAL_DOB = "SETTINGS_EDIT_PERSONAL_DOB",
  SETTINGS_EDIT_PERSONAL_GENDER = "SETTINGS_EDIT_PERSONAL_GENDER",
  SETTINGS_EDIT_PERSONAL_EMAIL = "SETTINGS_EDIT_PERSONAL_EMAIL",
  SETTINGS_EDIT_LOCATION = "SETTINGS_EDIT_LOCATION",
  SETTINGS_EDIT_LOCATION_ADDRESS = "SETTINGS_EDIT_LOCATION_ADDRESS",
  SETTINGS_EDIT_INDUSTRY = "SETTINGS_EDIT_INDUSTRY",
  SETTINGS_EDIT_EXPERIENCE = "SETTINGS_EDIT_EXPERIENCE",
  SETTINGS_EDIT_EDUCATION = "SETTINGS_EDIT_EDUCATION",
  SETTINGS_EDIT_EMPLOYMENT = "SETTINGS_EDIT_EMPLOYMENT",
  SETTINGS_EDIT_SALARY = "SETTINGS_EDIT_SALARY",
  SETTINGS_EDIT_PREFERENCES = "SETTINGS_EDIT_PREFERENCES",
  SETTINGS_EDIT_DRIVERS_LICENSE = "SETTINGS_EDIT_DRIVERS_LICENSE",
  SETTINGS_EDIT_DRIVERS_LICENSE_CODE = "SETTINGS_EDIT_DRIVERS_LICENSE_CODE",
  SETTINGS_EDIT_DOCUMENTS = "SETTINGS_EDIT_DOCUMENTS",
}
